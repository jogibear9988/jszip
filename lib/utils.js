 ...
 */
export function transformTo(outputType, input) {
    if (!input) {
        // undefined, null, etc
 ...
 */
export function checkSupport(type) {
 ...
 */
export function prepareContent(name, inputData, isBinary, isOptimizedBinaryString, isBase64) {
